...
return {
    ...
    'tpope/vim-rhubarb',
    {
        ...
        config = function() 
            ...
            vim.keymap.set('n', '<leader>vd', function () require('diffview').open() end, { desc = 'Open git DiffView' })
            vim.keymap.set('n', '<leader>vq', function () require('diffview').close() end, { desc = 'Close Git Diffview' })
        end,
    },
    {
